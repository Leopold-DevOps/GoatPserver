package com.company.assembleegameclient.objects
{
   ...
   public class Portal extends GameObject implements IInteractiveObject
   {
      ...
      /**
       * Portals offer the plaque whenever they are usable, without needing the
       * <ShowEnterButton/> flag other objects opt in with.
       */
      override protected function canShowEnterButton() : Boolean
      {
         return !this.lockedPortal_ && this.active_;
      }
